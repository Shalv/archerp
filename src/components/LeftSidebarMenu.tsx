  ...
  return (
    <>
      ...
      >
          ...
          <div className="p-2 border-b border-[#E2E8F0] bg-white shrink-0">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Find module (e.g. BOQ, DPR, PO)..."
                className="w-full pl-8 pr-7 py-1 text-xs bg-slate-50 border border-slate-200 rounded-md placeholder:text-[#94A3B8] focus:outline-none focus:ring-1 focus:ring-[#0F6CBD] focus:border-[#0F6CBD]"
              />
              {searchQuery && (
                <button
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-left transition relative group cursor-pointer ${
                            isActive
                              ? 'bg-[#EFF6FC] text-[#0F6CBD] font-semibold shadow-2xs border-l-3 border-[#0F6CBD]'
        ...
        {(!isCollapsed || isMobileOpen) && (
          <div className="p-2 border-t border-[#E2E8F0] bg-white shrink-0 space-y-1">
            <button
